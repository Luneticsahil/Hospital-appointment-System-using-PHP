...
<head>
	...
	<title>HealthHub - Login Page</title>
...
<body class="simple-page">
	<div id="back-to-home">
		<a href="../index.php" class="btn btn-outline btn-default"><i class="fa fa-hospital-o animated zoomIn"></i><br>Home</a>
	</div>
	<div class="simple-page-wrap">
		<div class="simple-page-logo animated swing">
			
				<span style="color: white"><i class="fa fa-heartbeat"></i></span>
				<span style="color: white">HealthHub</span>
			
		</div><!-- logo -->
		<div class="simple-page-form animated flipInY" id="login-form">
	<h4 class="form-title m-b-xl text-center">Sign Up With Your HealthHub Account</h4>
